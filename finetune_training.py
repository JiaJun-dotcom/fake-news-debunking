# Trains a distilBERT transformer fine-tuned on fake/real news data from MongoDB to return a label of fake/real news, and also use available text embeddings to do semantic similarity search for more convincing explanation and relation to .
